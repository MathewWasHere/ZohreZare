            ...
            '<div>' +
              ...
              '<div class="reveal" style="margin-top:var(--sp-6);">' +
                ...
                '<div class="note note--warn" style="margin-top:var(--sp-3);">' +
                  ZZ.icon('info') +
                  '<span>قیمت‌های این صفحه موقت هستند و ممکن است تا زمان نهایی‌شدن تعرفه تغییر کنند. ' +
                  'قیمت نهایی در جلسه‌ی مشاوره و بر اساس وضعیت لب، مژه و ابروی شما اعلام می‌شود.</span>' +
                '</div>' +
              '</div>' +
