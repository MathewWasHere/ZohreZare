    ...
    return '<div class="svc-editor">' + state.services.map(function (s) {
      ...
      return '<article class="svc-card' + (open ? ' is-open' : '') + '" data-svc="' + s.id + '">' +
        ...
        '<div class="svc-card__body"><div class="svc-card__body__inner">' +
          ...
          /* اعداد فعلی تعرفه‌ی واقعی نیستند؛ این جمله به مدیر می‌گوید
             که باید همین‌جا واردشان کند. */
          svcSection(2, 'گزینه‌ها و قیمت‌ها',
            'هر گزینه، قیمت و مدت مخصوص خودش را دارد. اعداد فعلی فرضی‌اند — ' +
            'تعرفه‌ی واقعی سالن را همین‌جا وارد کنید؛ روی سایت و فرم رزرو ' +
