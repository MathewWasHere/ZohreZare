...
(function (global) {
  ...
  var paths = {
    ...
    /* ابرو: کمان ابرو با چند تار مو در ابتدای آن */
    brow:  '<path d="M3.4 14.6c2.6-4.6 6.2-6.9 10.9-6.9 2 0 3.7.4 5.1 1.2" ' + P + '/>' +
           '<path d="M5.6 15.4 7.7 9.6M8.8 12.9 10 9.1M12 12.1V8.6" ' + P + ' opacity="0.8"/>',
