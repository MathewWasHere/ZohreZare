...
(function (global) {
  ...
  var paths = {
    ...
    /* کیک تولد — جایگزین ایموجی 🎂 (ایموجی به‌عنوان آیکون ممنوع) */
    cake:  '<path d="M4 21h16" ' + P + '/>' +
           '<path d="M5 21v-6a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v6" ' + P + '/>' +
           '<path d="M5 16.5s1.2-.9 2.4 0 2.4.9 3.6 0 2.4-.9 3.6 0 2.4.9 3.4 0" ' + P + '/>' +
           '<path d="M8 9.5v3M12 9.5v3M16 9.5v3" ' + P + '/>' +
           '<path d="M8 6.6v.01M12 6.6v.01M16 6.6v.01" ' + P + '/>',
    chevronRight: '<path d="m9 5 7 7-7 7" ' + P + '/>',
    chevronUp:   '<path d="m5 15 7-7 7 7" ' + P + '/>',

    /* چشم — برای «مشاهده‌ی صفحه» در پنل مدیریت */
    eye: '<path d="M2.5 12S6 5.8 12 5.8 21.5 12 21.5 12 18 18.2 12 18.2 2.5 12 2.5 12z" ' + P + '/>' +
         '<circle cx="12" cy="12" r="2.7" ' + P + '/>',

    search: '<circle cx="11" cy="11" r="7" ' + P + '/><path d="m20.3 20.3-3.6-3.6" ' + P + '/>',

    users: '<circle cx="9" cy="8.2" r="3.4" ' + P + '/>' +
           '<path d="M3 19.6a6.3 6.3 0 0 1 12 0" ' + P + '/>' +
           '<path d="M15.5 5.1a3.4 3.4 0 0 1 0 6.2" ' + P + '/>' +
           '<path d="M17.6 13.7a6.3 6.3 0 0 1 3.4 4.7" ' + P + '/>',

    /* کیف پول — برای بیعانه و مبالغ دریافتی */
    wallet: '<path d="M4 7.5A2.5 2.5 0 0 1 6.5 5h11A2.5 2.5 0 0 1 20 7.5v9a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 16.5z" ' + P + '/>' +
            '<path d="M20 10.5h-4.2a1.8 1.8 0 0 0 0 3.6H20" ' + P + '/>'
  };
