...
INSERT INTO services
  (id, slug, title, short_text, image, icon, ig_link, duration_min,
   ...
   sort_order, active)
VALUES (
  'svc_permanent_liner', 'permanent-liner', 'خط چشم دائم و میکروبلیدینگ',
  'خط چشم و ابروی ماندگار با طراحی دقیق و رنگ‌های طبیعی، متناسب با فرم صورت.',
  'assets/img/service-permanent-liner.jpg', 'liner', NULL,
  150, 2500000,
  '["در خط چشم دائم، رنگ‌دانه‌ی تخصصی در لایه‌ی سطحی پوست پلک قرار می‌گیرد تا خطی ماندگار و همیشه مرتب داشته باشید. در میکروبلیدینگ ابرو نیز با تیغه‌های بسیار ظریف، خطوطی شبیه تار موی طبیعی ایجاد می‌شود.","کار با طراحی روی پوست شروع می‌شود: قبل از هر کار دائمی، فرم پیشنهادی را روی صورت شما رسم می‌کنیم و تا زمانی که کاملاً راضی نشوید، مرحله‌ی بعد را شروع نمی‌کنیم.","قبل از شروع از کرم بی‌حسی موضعی استفاده می‌شود و در بیشتر موارد حس شما چیزی بین خارش خفیف و فشار ملایم است. رنگ‌های مورد استفاده استاندارد و قابل جذب هستند."]',
  ...
  '["کسانی که وقت آرایش روزانه ندارند","ابروی کم‌پشت یا نامتقارن","حساسیت به لوازم آرایش"]',
...
INSERT INTO service_variants
  (service_id, variant_key, name, note, duration_min, price, sort_order)
VALUES ('svc_permanent_liner', 'microblading', 'میکروبلیدینگ ابرو', 'تار به تار؛ شبیه موی طبیعی ابرو', 165, 3800000, 2)
ON DUPLICATE KEY UPDATE
  name = VALUES(name), note = VALUES(note),
  duration_min = VALUES(duration_min), price = VALUES(price),
  sort_order = VALUES(sort_order);
INSERT INTO service_variants
  (service_id, variant_key, name, note, duration_min, price, sort_order)
VALUES ('svc_permanent_liner', 'touchup', 'ترمیم دوره‌ای', 'یک تا دو سال بعد از جلسه‌ی اصلی', 90, 1400000, 3)
ON DUPLICATE KEY UPDATE
  name = VALUES(name), note = VALUES(note),
  duration_min = VALUES(duration_min), price = VALUES(price),
  sort_order = VALUES(sort_order);
